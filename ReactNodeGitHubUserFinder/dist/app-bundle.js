...
const Card = (props) => {
    return (React.createElement("div", { className: "floatleft" },
        React.createElement("img", { width: "250", src: props.avatar_url }),
        React.createElement("span", { className: "space20" }, props.name),
        React.createElement("span", { className: "space20" }, props.company),
...
class Form extends React.PureComponent {
    ...
    render() {
        return (React.createElement("form", { onSubmit: this.handleSubmit },
            React.createElement("input", { type: "text", value: this.state.userName, onChange: (event) => this.setState({
...
class App extends React.PureComponent {
    ...
    render() {
        return (React.createElement("div", null,
            ...
            React.createElement(Form, Object.assign({}, this.props, { onSubmit: this.addNewCard }))));
    }
}
