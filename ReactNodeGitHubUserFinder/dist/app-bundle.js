...
const Card = (props) => {
    return (React.createElement("div", { className: "floatleft" },
        React.createElement("img", { width: "250", src: props.imgUrl }),
        React.createElement("span", { className: "space20" }, props.Name),
...
const CardList = (props) => {
    return (React.createElement("div", null,
        React.createElement(Card, Object.assign({}, this.props, { imgUrl: 'https://avatars3.githubusercontent.com/u/20?v=4', Name: 'Kevin Clark' })),
        React.createElement(Card, Object.assign({}, this.props, { imgUrl: 'https://avatars0.githubusercontent.com/u/1?v=4', Name: 'Tom Preston-Werner' }))));
};
ReactDOM.render(React.createElement(CardList, null), document.getElementById('root'));
